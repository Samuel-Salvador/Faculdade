...
public class NavegaFilmes extends JFrame {
    ...
    public void carregarTabela() {
        String sql = "SELECT * FROM planejamentopessoal.filmes ORDER BY codigo";
        try {
            statement = bd.connection.prepareStatement(sql,ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
