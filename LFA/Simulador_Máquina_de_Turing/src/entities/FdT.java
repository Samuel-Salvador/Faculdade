...
public class FdT {
	...
	private String lerNaFita;
	private String trocarNaFita;
	private Character direcao;

	public FdT(int estadoPertence) {
		this.estadoPertence = estadoPertence;
	}
	public FdT(int estadoPertence, int estadoProximo, String lerNaFita, String trocarNaFita, Character direcao) {
		super();
		this.estadoPertence = estadoPertence;
	...
	public String getLerNaFita() {
		return lerNaFita;
	}

	public void setLerNaFita(String lerNaFita) {
		this.lerNaFita = lerNaFita;
	}

	public String getTrocarNaFita() {
		return trocarNaFita;
	}

	public void setTrocarNaFita(String trocarNaFita) {
		this.trocarNaFita = trocarNaFita;
	}
